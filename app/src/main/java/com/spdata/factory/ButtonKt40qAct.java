...
/**
 * Created by lenovo_pc on 2016/10/14.
 */
public class ButtonKt40qAct extends FragActBase implements View.OnClickListener {
    ...
    public void isall() {
        if (btn_0.isPressed() && btn_1.isPressed() && btn_2.isPressed() && btn_3.isPressed()
                ...
                && btn_up.isPressed() && btn_down.isPressed() && btn_f5.isPressed() && btn_f6.isPressed() &&
                btn_f10.isPressed() && btn_camera.isPressed()) {
